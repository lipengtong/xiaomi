<jsp:useBean id="product" scope="request" type="com.offcn.entity.Product"/>
    ...
    <div class="plus5_no3">
        <div class="plus5_no3_img">
            <img width="560px" height="560px"
                 src="${pageContext.request.contextPath}/pic/${product.pic}" style="display: block" alt="">
        </div>
        <div class="plus5_no3_right">
            ...
            <a href="javascript:void(0)" onclick="addTrolley()" ><div class="plus5_no3_right_div11" style="cursor:pointer;">加入购物车</div></a>
...
<script>
    function  addTrolley () {
        ...
        $.ajax({
            ...
            "type":"post",
            "data":{"mark":"addTrolley","count":count,"pid":pid},
            "dataType":"text",
