...
<body>
        ...
        <div class="inner whiteGL">
            ...
            <div class="right">
               <c:if test="${empty user}">
                ...
                <a href="${pageContext.request.contextPath}/trolleyServlet?mark=showInfo">购物车:${count}</a>
                <a href="${pageContext.request.contextPath}/ordersServlet?mark=showInfoOrders">历史订单</a>
                <a href="${pageContext.request.contextPath}/admin/main.jsp">跳转到后台</a>
            </div>
        </div>
    </div>
    <div class="logo">
    ...
    <div class="time">
        ...
        <div class="time_in">
                       <%--开始--%>
                      <c:forEach items="${productStateList}" var="product" varStatus="sta">
                          <c:if test="${sta.index <5}">
		            <div style="background-color: #fff;width: 234px;height:320px;float: left;margin-left: 11px; ">
		            	<a href="${pageContext.request.contextPath}/productServlet?mark=showInfoProductById&pid=${product.pid}" target="_self">
		            		<img class="time_min" style="width:234px;height: 234px;" src="${pageContext.request.contextPath}/pic/${product.pic}" alt="">
		            	</a>
        ...
        <div class="app_width" style="padding-top: 0px">
            ...
            <div class="app_max">
                ...
                <div class="appr">
                  ...
                  <c:forEach items="${productList}" var="offcn" varStatus="i">

                          <c:if test="${i.count <=4 }">
                                <div class="appr_min" id="appr_min1" style="margin-left: 12px;width: 234px;height: 300px;background-color: #FFF;text-align: center;">
                                    <a href="${pageContext.request.contextPath}/productServlet?mark=showInfoProductById&pid=${offcn.pid}" target="_self"><img width="180px" height="180px;"
                                                                    src="${pageContext.request.contextPath}/pic/${offcn.pic}" alt=""></a>

                                    <div style="width: 234px;height: 100px;">
                                        <div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">${offcn.name}</div>
                                        <div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">${offcn.description}</div>
                                        <div style="width: 100%;height: 33px;text-align: center;color: #ff6700;font-size: 14px;font-family: Arial">${offcn.price}</div>
                                    </div>
                                </div>
                           </c:if>
                            <c:if test="${i.count > 4 }">
                                <div class="appr_min" style="margin-left: 12px;width: 234px;height: 300px;background-color: #FFF;text-align: center;margin-top: 15px;" id="appr_min1">
                                    <a href="${pageContext.request.contextPath}/productServlet?mark=showInfoProductById&pid=${offcn.pid}" target="_self"><img width="180px" height="180px;" src="${pageContext.request.contextPath}/pic/${offcn.pic}" alt=""></a>
                                    <div style="width: 234px;height: 100px;">
                                        <div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">${offcn.name}</div>
                                        <div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">${offcn.description}</div>
                                        <div style="width: 100%;height: 33px;text-align: center;color: #ff6700;font-size: 14px;font-family: Arial">${offcn.price}</div>
    ...
    <%--<div class="capabackground">
        <div class="capacity" style="padding-top: 0px">
            <div class="capa_box_top">
                <div class="capa_box_top_al">中公老师</div>
