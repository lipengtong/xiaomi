        ...
        if(ids.length>0){
            if(confirm("确认操作?")){
                ...
                $.ajax({
                    ...
                    "type":"post",
                    "data":{"mark":"addOrders","ids":strIds},
                    "dataType":"text",
                    "success":function (data) {
                       if (data=="true"){
                           alert("成功");
                           window.location.href="${pageContext.request.contextPath}/ordersServlet?mark=payMoney&ids="+strIds;
                       }else {
                           alert("失败");
                       }
                    },
...
<div class="box">
        ...
        <div class="head_background">
            <div class="head_box">
                ...
                <div class="head_right">
                    <span class="head_right_in" onclick="deleteAll(-1)">清空购物车 </span>
                </div>
    ...
    <div class="trolley_background">
            ...
            <div class="tro_tab_h">
	            ...
	            <div class="tro_tab_h1">
	               ...
	               <li class="tro_tab_name_li1" style="font-size: 16px;">${trolley.product.name}</li>
	                ...
	                <div class="col tro_tab_action" style="cursor: pointer;width: 40px;height: 40px;" onclick="deleteAll('${trolley.tid}')">删除</div>
	            </div>
        ...
        <div class="tro_close_bot ">
            ...
            <p class="tro_close_p_r" style="cursor: pointer;" onclick="delAll()">去结算</p>
        </div>

    </div>

<script>
    function deleteAll(temp) {
        //发送ajax请求
        $.ajax({
            "url":"${pageContext.request.contextPath}/trolleyServlet",
            "type":"post",
            "data":{"mark":"deleteAll","tid":temp},
            "dataType":"text",
            "success":function (data) {
                if (data=="true"){
                    alert("删除成功");
                ...
                window.location.href="${pageContext.request.contextPath}/trolleyServlet?mark=showInfo";
            },
            "error":function () {
                alert("请求失败");
            }
