...
public class Orders implements Serializable {
    ...
    public Orders(String orders_number, int uid, double sum_price, int state,
                  int count_number, List<Trolley> trolleyList) {
    ...
    public void setOrders_number(String orders_number) {this.orders_number = orders_number;
    }
    public int getUid() {
        return uid;
    }
